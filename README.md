...
Свойство | Возможное значение | Описание | Комментарий
--- | --- | --- | ---
a11y | {} | Задает aria для кнопок | Ниже будет код, который используется по умолчанию
allowSlideNext | true или false | Запрещает или разрешает нажатие на следующий слайд по кнопке стрелочке | По умолчанию true
allowSlidePrev | true или false | Запрещает или разрешает нажатие на предыдущий слайд по кнопке стрелочке | По умолчанию true
allowTouchMove | true или false | Запрещает или разрешает перетаскивание слайда через touch на телефоне или планшете | По умолчанию true
...
Свойство | Возможное значение | Описание | Комментарий
--- | --- | --- | ---
effect | 'cards', 'slide', 'fade', 'flip', 'cube', 'coverflow' | Эффекты переключения слайдов | Работает нормально только с slidesPerView: 1

> Если effect : 'creative', то к нему открываются дополнительные настройки

Свойство | Возможное значение | Описание | Комментарий
--- | --- | --- | ---
creativeEffect | {} | Смена слайдов по оси Z | ---
...
> Если effect : 'cards', то слайды листаются как карточки
